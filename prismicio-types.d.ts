...
export interface SettingDocumentDataNavItemItem {
   ...
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: setting.nav_item[].lable
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
...
interface SettingDocumentData {
   ...
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: setting.twitteer_link
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
  twitteer_link: prismic.LinkField;
...
export interface BiographySliceDefaultPrimary {
  ...
  /**
   * Butten Text field in *Biography → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: biography.primary.butten_text
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  butten_text: prismic.KeyTextField;

  /**
   * Butten Link field in *Biography → Primary*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: biography.primary.butten_link
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
  butten_link: prismic.LinkField;
